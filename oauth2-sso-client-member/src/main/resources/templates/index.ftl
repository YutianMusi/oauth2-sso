...
<body class="main_body"></body>
<div class="layui-layout layui-layout-admin">
    <div class="layui-header header">
        <div class="layui-main">
            <a href="#" class="logo">高先森你别走</a>
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:">
                        <img src="<#if (currentUser.icon??)>${currentUser.icon}<#else>${base}/images/face.jpg</#if>" class="layui-circle" width="35" height="35">
                        <cite><#if authentication.name!''>${authentication.name}<#else>${authentication.name}</#if></cite>
                    </a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="<#if (currentUser.icon??)>${currentUser.icon}<#else>${base}/images/face.jpg</#if>"></a>
            <p>你好！<span class="userName"><#if Session.SPRING_SECURITY_CONTEXT.authentication.principal.username!''>${Session.SPRING_SECURITY_CONTEXT.authentication.principal.username}<#else>${Session.SPRING_SECURITY_CONTEXT.authentication.principal.username}</#if></span>, 欢迎登录</p>
        </div>
...
<script type="text/javascript" src="${base}/js/leftNav.js?v=2.0"></script>
<script type="text/javascript" src="${base}/js/index.js?t=3.0"></script>
</body>
</html>